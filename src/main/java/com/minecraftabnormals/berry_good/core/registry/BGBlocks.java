...
public class BGBlocks {
    ...
    public static final RegistryObject<Block> SWEET_BERRY_SEEDS = RegistryUtils.createBlockNoItem("sweet_berry_bush_seeds", () -> new BlockSweetBerryBush(Block.Properties.from(Blocks.SWEET_BERRY_BUSH)));
}
